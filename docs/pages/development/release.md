...
If you need to get a release, simply create an [Issue](https://github.com/Marcel2603/ldap-password-change/issues) or
...
| Type             | Arc                                      | Link                                                                     |
|------------------|------------------------------------------|--------------------------------------------------------------------------|
| Docker Container | arm64 and amd64 for linux                | <https://github.com/Marcel2603/ldap-password-change/pkgs/container/ldap-password-change%2Fldap-password-change> |
| Executable       | arm64 and amd64 for linux/darwin/windows | <https://github.com/Marcel2603/ldap-password-change/releases>                         |
